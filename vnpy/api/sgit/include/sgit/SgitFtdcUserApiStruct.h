...
struct CThostFtdcDepthMarketDataField
{
	...
	//合约序号
	TThostFtdcSequenceNoType InstrumentNo;
	//增量行情报文的最新编号
	TThostFtdcSequenceNoType PacketNo;
	//数据中心编号
	TThostFtdcExchangePropertyType CenterChangeNo;
	//合约基准价
	TThostFtdcPriceType          CodecPrice;
	//Tick
	TThostFtdcPriceType          PriceTick;
	//合约乘数
	TThostFtdcVolumeType         VolumeMultiple;
};
