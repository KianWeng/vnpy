...
#ifdef LIB_FS_TRADER_API_EXPORT
#define FS_TRADER_API_EXPORT __declspec(dllexport)
#else
#define FS_TRADER_API_EXPORT __declspec(dllimport)
#endif
#else
#define FS_TRADER_API_EXPORT 
#endif
namespace fstech{
//
